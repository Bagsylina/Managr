...
namespace Managr.Data.Migrations
{
    ...
    [Migration("20231217132035_AddProject")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Managr.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Managr.Models.Task", b =>
                {
                    ...
                    b.Property<string>("ProjectOrganizerId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("ProjectId", "ProjectOrganizerId");
            ...
            modelBuilder.Entity("Managr.Models.Project", b =>
                {
                    b.HasOne("Managr.Models.ApplicationUser", "Organizer")
                        .WithMany("Projects")
            ...
            modelBuilder.Entity("Managr.Models.Task", b =>
                {
                    b.HasOne("Managr.Models.Project", "Project")
                        .WithMany("Tasks")
                        .HasForeignKey("ProjectId", "ProjectOrganizerId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Managr.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
